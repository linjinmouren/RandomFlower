    ...
    public void tickFlower() {
        ...
        if (!this.getLevel().isClientSide && this.redstoneSignal <= 0) {
            ...
            while(var2.hasNext()) {
                ...
                if ((entity instanceof Player) && entity.getEffect(ExtraBotanyEffects.reflect) == null && this.getMana() >= 20 && !entity.level().isClientSide && entity.getMobType() != MobType.UNDEAD) {
                    entity.addEffect(new MobEffectInstance(ExtraBotanyEffects.reflect, 8 * 30, 0));
                    this.addMana(-20);
                }
            }
