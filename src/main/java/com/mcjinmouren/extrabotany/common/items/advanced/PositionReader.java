...
import com.mcjinmouren.extrabotany.api.core.PlayerChat;
...
public class PositionReader extends Item {
    ...
    public InteractionResult useOn(UseOnContext context) {
        ...
        if (!player.isShiftKeyDown()) {
            ...
            PlayerChat.sendStatusMessage(player, PlayerChat.lang("item.extrabotany.location.saved") + BlockPosDim.blockPosToString(pos));
    ...
    public static BlockPosDim getPosition(ItemStack item) {
        ...
        try {
            ...
            ExtraBotany.LOGGER.error("SIde error in Read Position", e);
        }
        return dim;
    }
}
